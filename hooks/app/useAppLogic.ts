...
import { getUserInfoApi } from '../../services/api/sparkxChatApi';
import { isLoggedIn, clearAuthToken } from '../../utils/authUtils';
...
export const useAppLogic = () => {
  ...
  const chatState = useChat(appSettings, setAppSettings, language, currentUser, setIsLoginModalOpen);
  ...
  const handleLogout = useCallback(() => {
    clearAuthToken();
    setCurrentUser(null);
    chatState.setSavedSessions([]);
    chatState.setSavedGroups([]);
